...
package ngothiphuongtrang_lsbimage;
...
import static ngothiphuongtrang_lsbimage.NgoThiPhuongTrang_LSBImage.workingDir;


public class NgoThiPhuongTrang_LSBImage {
    public static String workingDir;
public static void main(String [] args) throws Exception{
    System.out.println("lsb.image_thao.LSBImage_thao.main()");
...
class ImageProcess{
	BufferedImage fetchImage() throws Exception{
		File f = new File(workingDir+"\\src\\DuLieu\\header_navigation.png");
